...
function LinkedinIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.36V9h3.41v1.56h.05c.47-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.21 0 22.23 0z" />
    </svg>
  );
}
...
const socials = [
  {
    label: "Email",
    href: "mailto:navehlavan@gmail.com",
    icon: ({ size }: { size?: number }) => <Mail size={size} />,
  },
  {
    label: "GitHub",
    href: "https://github.com/LaVaughnGit",
    icon: GithubIcon,
  },
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/lavan-naveh",
    icon: LinkedinIcon,
  },
];
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          {socials.map(({ label, href, icon: Icon }) => (
            ...
            >
              <span className="p-3 rounded-full border border-border group-hover:border-foreground transition-colors">
                <Icon size={20} />
              </span>
